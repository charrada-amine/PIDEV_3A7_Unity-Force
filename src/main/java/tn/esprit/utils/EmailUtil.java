...
public class EmailUtil {
    ...
    private static final String SMTP_USERNAME = "charradinoamine@gmail.com"; // Votre adresse e-mail
    private static final String SMTP_PASSWORD = "pftu wjdg olnt anpw"; // Votre mot de passe
